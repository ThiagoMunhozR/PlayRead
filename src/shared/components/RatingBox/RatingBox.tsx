...
export const RatingBox: React.FC<RatingBoxProps> = ({ value, onChange, isLoading = false, isMobile = false }) => (
  isMobile ? (
    <Box component={Paper} elevation={0} sx={{ p: 2, borderRadius: 2, width: '100%', boxSizing: 'border-box', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent', border: '2px solid', borderColor: 'divider', gap: 1 }}>
      <Typography variant="body1" sx={{ minWidth: 90, textAlign: 'right', mr: 1 }}>Avaliação:</Typography>
      <IconButton
